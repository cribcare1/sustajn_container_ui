        ...
        builder: (context, setDialogState) {
          return AlertDialog(
            title: Center(
              child: Text(
                'Approve Request',
                style: TextStyle(fontSize: Constant.LABEL_TEXT_SIZE_18),
              ),
            ),
            content: Column(
                  ...
                  TextButton(
                    onPressed: () {
                      ...
                      _showSuccessSnackBar(
                        'Request approved for $approvedQuantity containers',
                      );
                    },
                    child: Text('Approve',
                      style: TextStyle(
  ...
  void _showRejectDialog(ContainerRequest request) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to reject the container request from ${request.restaurantName}?',
        ),
        actions: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              TextButton(
                ...
                child: Text(
                  'Cancel',
                  style: TextStyle(color: Constant.greyshade100),
                ),
              ),
              TextButton(
                onPressed: () {
                ...
                children: [
                  Expanded(
                    child: TextButton.icon(
                      ...
                      icon: Icon(Icons.close, size: Constant.CONTAINER_SIZE_16, color: Colors.red.shade200,),
                      label: Text(
                        'Reject',
                        style: TextStyle(
