                      ...
                      Expanded(
                        child: Row(
                          ...
                          children: [
                            ...
                            VerticalDivider(color: Colors.black,thickness: 1,indent: 1,),
                            // RIGHT CONTENT AREA
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: showMonthView ? _buildMonthView(years) : _buildContainerView(),
                              ),
                            ),
                          ],
                        ),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(id, style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
                      ],
                    ),
