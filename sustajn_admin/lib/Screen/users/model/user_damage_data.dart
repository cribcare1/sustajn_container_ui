class UserDamageData {
  List<DamageDataList>? data;
  String? message;
  String? status;

  UserDamageData({this.data, this.message, this.status});

  UserDamageData.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <DamageDataList>[];
      json['data'].forEach((v) {
