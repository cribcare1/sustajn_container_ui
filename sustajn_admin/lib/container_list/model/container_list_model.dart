class ContainerListModel {
  ...
  ContainerListModel(
      {this.inventoryData, this.count, this.message, this.status});
...
class InventoryData {
  ...
  InventoryData.fromJson(Map<String, dynamic> json) {
    ...
    colour = json['colour'] ?? '';
    lengthCm = json['lengthCm'] ?? 0.0;
    widthCm = json['widthCm'] ?? 0.0;
    heightCm = json['heightCm'] ?? 0.0;
