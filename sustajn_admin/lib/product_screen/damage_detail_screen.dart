...
final damageTabProvider =
StateProvider<DamageTab>((ref) => DamageTab.user);

class DamagedDetailsScreen extends ConsumerStatefulWidget {
  const DamagedDetailsScreen({super.key});
              ...
              child: Row(
                children: [
                  _segment(
                    ...
                    onTap: () {
                      ref
                          .read(damageTabProvider.notifier)
                          .state =
                          DamageTab.user;
                    },
                  ),
...
class _PartnerUI extends StatelessWidget {
  ...
  Widget _partnerCard(String title,
      String subtitle,
      String qty,) {
    return Container(
      margin: EdgeInsets.only(bottom: Constant.CONTAINER_SIZE_14),
