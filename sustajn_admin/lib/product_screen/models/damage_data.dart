...
class DamagedList {
  ...
  List<DamagedContainers>? damageContainers;
  ...
  DamagedList.fromJson(Map<String, dynamic> json) {
    ...
    if (json['damageContainers'] != null) {
      damageContainers = <DamagedContainers>[];
      json['damageContainers'].forEach((v) {
        damageContainers!.add(new DamagedContainers.fromJson(v));
      });
    }
  }
...
class DamagedContainers {
  ...
  DamagedContainers.fromJson(Map<String, dynamic> json) {
