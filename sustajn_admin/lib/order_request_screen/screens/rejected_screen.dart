            ...
            Expanded(
              child: orderRequestState.isLoading
                ...
                child: Text(
                  ...
                  : (orderRequestState.getRejectDataList.isEmpty && searchController.text.isNotEmpty)
                  ? Center(
                child: Column(
                ...
                itemCount: orderRequestState.getRejectDataList.length,
                itemBuilder: (context, index) {
                  final item = orderRequestState.getRejectDataList[index];
