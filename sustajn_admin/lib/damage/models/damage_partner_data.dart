class DamagePartnerData {
  List<DamagePartnerDataList>? data;
  String? message;
  String? status;

  DamagePartnerData({this.data, this.message, this.status});

  DamagePartnerData.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <DamagePartnerDataList>[];
      json['data'].forEach((v) {
        data!.add(new DamagePartnerDataList.fromJson(v));
      });
    }
