class DamageUserData {
  List<DamageUserDataList>? data;
  String? message;
  String? status;

  DamageUserData({this.data, this.message, this.status});

  DamageUserData.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <DamageUserDataList>[];
      json['data'].forEach((v) {
        data!.add(new DamageUserDataList.fromJson(v));
      });
    }
...
class DamageUserDataList {
  ...
  DamageUserDataList.fromJson(Map<String, dynamic> json) {
