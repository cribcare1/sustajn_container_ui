...
class BankDetailService {
  Future<dynamic> createBankService(String url, Map<String, dynamic> requestData, String requestType) async {
    try {
...
final bankApiService = Provider<BankDetailService>(
      (ref) => BankDetailService(),
);
